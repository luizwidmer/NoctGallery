# Noct Gallery privacy policy update — draft for publication

Effective upon publication. This file is a release draft; it has not replaced the existing support-site policy.
...
For questions or support, contact the developer through [luizwidmer.com](https://luizwidmer.com/).
